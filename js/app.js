...
async function doLogin() {
  ...
  try {
    ...
    btn.innerHTML = '<img class="google-mark" src="GoogleG.svg?v=2103" alt="">Continue with Google';
    btn.disabled = false;
  }
}
...
function showLogin() {
  ...
  document.getElementById('login-btn').innerHTML = '<img class="google-mark" src="GoogleG.svg?v=2103" alt="">Continue with Google';
...
(async () => {
  if ('serviceWorker' in navigator) {
    try {
      await navigator.serviceWorker.register('./sw.js?v=2103');
    } catch (e) {
