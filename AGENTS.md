...
- Current visible app version is in `index.html` as `.app-version` (`v2.0.9`). If behavior changes visibly, update cache-busting query strings and version consistently.
