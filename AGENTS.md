...
- Current visible app version is in `index.html` as `.app-version` (`v1.9.2`). If behavior changes visibly, update cache-busting query strings and version consistently.
